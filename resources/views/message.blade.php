        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/user_message" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>View Messages</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="view_message/{{$message['id']}}" class="btn btn-primary">View</a></td>
