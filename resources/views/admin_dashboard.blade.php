        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="{{ url('index') }}" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>Raji Ola & Co</h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    
                </div>
                <div class="navbar-nav w-100">
                    <a href="/view_all_property" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Home</a>

                    <a href="/create_property" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Property</a>
                    <a href="/create_propertytype" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Category</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit_property/{{$property['id']}}" class="btn btn-primary">Update</a></td>

                                            <td><a href="delete_property/{{$property['id']}}" class="btn btn-danger">Delete</a></td>
