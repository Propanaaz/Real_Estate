        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/view_all_property" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Manage Properties</a>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="name" id="floatingInput"
                                    placeholder="name@example.com" value="{{$property['name']}}">
                                <label for="floatingInput">Property Name</label>
                                
                            </div>
                           
                            <div class="form-floating mb-3">
                                <select class="form-select mb-3" aria-label="Default select example" name="propertytype" required>
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="location" id="floatingInput"
                                    placeholder="name@example.com" value="{{$property['location']}}">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="price" id="floatingInput"
                                    placeholder="name@example.com" value="{{$property['price']}}">
                                ...
                                <textarea class="form-control" placeholder="Type your post here...."
                                    id="floatingTextarea" style="height: 150px;" name ="description">{{$property['description']}}</textarea>
...
<br>
                            <input type="text" name="pid" value="{{$property['id']}}" style="display: none;">
