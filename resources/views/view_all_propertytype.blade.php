        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/create_propertytype" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Add Category</a>
                    <a href="/view_all_propertytype" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Manage Category</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$propertytype['description']}}</td>
                                                                                        <td><a href="edit_propertytype/{{$propertytype['id']}}" class="btn btn-primary">Update</a></td>

                                            <td><a href="delete_propertytype/{{$propertytype['id']}}" class="btn btn-danger">Delete</a></td>
