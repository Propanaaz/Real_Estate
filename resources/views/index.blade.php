        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Find A <span class="text-primary">Perfect Location</span> To Plan Your Future</h1>
                    

                    <h2 class="animated fadeIn mb-4 pb-2">
                        Building <span class="text-primary">Consultant</span> 
                        <br>
                        Building <span class="text-primary">Approval & Drawing</span>
                        <br>
                        Estate <span class="text-primary">Management</span>
                        <br>
                        Estate <span class="text-primary">Supervisor</span>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>View the wide range of properties tht you can invest in</p>
                </div>
                <div class="row g-4">
                    @foreach($propertytype as $propertytype)
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="/property-list/{{$propertytype['property_type']}}">
                            <div class="rounded p-4">
                                <div class="icon mb-3">
                                    <img class="img-fluid" src="{{ url('img/icon-apartment.png') }}" alt="Icon">
                                </div>
                                <h6>{{$propertytype['property_type']}}</h6>
                                <span>{{count($propertytype->catprop)}}</span>
                            </div>
                        </a>
                    </div>
                    @endforeach
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="about-img position-relative overflow-hidden p-5 pe-0">
                            <img class="img-fluid w-100" src="{{ url('images/homepage.png') }}">
                        </div>
                    </div>
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active" >
                        <div class="row g-4" >
                            @if(count($property) > 0){
                                ...
                                <div  class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style="margin-left:-5px;">
                                    <div class="property-item rounded overflow-hidden">`
                                        <div class="position-relative overflow-hidden">
                                            <a href="property-detail/{{$property['id']}}"><img style=" height:300px; width:500px;" class="img-fluid" src="{{ url('images/'.$property['image1']) }}" alt="" ></a>
                                            <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">For {{ $property['tag'] }}</div>
                                            <div class="bg-white rounded-top text-primar`y position-absolute start-0 bottom-0 mx-4 pt-1 px-3">{{ $property['propertytype'] }}</div>
                                        </div>
                                        <div class="p-4 pb-0">
