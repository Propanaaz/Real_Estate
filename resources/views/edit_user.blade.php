        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/_user" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Manage Account</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h3 class="mb-4">Manage User Account</h3>
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control"  id="floatingInput"
                                    placeholder="Designation" name="designation" value="{{$user['designation']}}">
                            ...
                            <input type="text" name="pid" value="{{$user['id']}}" style="display: none;">
