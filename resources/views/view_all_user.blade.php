        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/view_all_user" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Manage Account</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$user['email']}}</td>
                                            <td>{{$user['phone']}}</td>
                                            <td><a href="edit_user/{{$user['id']}}" class="btn btn-primary">Update</a></td>

                                            <td><a href="delete_agent/{{$user['id']}}" class="btn btn-danger">Update</a></td>
